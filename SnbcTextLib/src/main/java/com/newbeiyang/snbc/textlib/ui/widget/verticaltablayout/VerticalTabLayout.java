package com.newbeiyang.snbc.textlib.ui.widget.verticaltablayout;
...
import com.newbeiyang.snbc.textlib.common.DisplayUtil;
import com.newbeiyang.snbc.textlib.ui.widget.verticaltablayout.adapter.TabAdapter;
import com.newbeiyang.snbc.textlib.ui.widget.verticaltablayout.widget.QTabView;
...
public class VerticalTabLayout extends ScrollView {
    ...
    public VerticalTabLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mColorIndicator = typedArray.getColor(R.styleable.VerticalTabLayout_indicator_color,
                context.getResources().getColor(R.color.tanant_count));
